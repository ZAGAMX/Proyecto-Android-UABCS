package com.example.zagamx.proyectofinalpma.Fragments;
...
import com.example.zagamx.proyectofinalpma.Calificaciones.calificacion;
import com.example.zagamx.proyectofinalpma.Horario.Horarios;
import com.example.zagamx.proyectofinalpma.Perfil.Notes_Perfil;
import com.example.zagamx.proyectofinalpma.Perfil.Sesion;
import com.example.zagamx.proyectofinalpma.R;
import com.example.zagamx.proyectofinalpma.Shared.SharedLogin;
import com.example.zagamx.proyectofinalpma.about;
...
public class Perfil extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView n = view.findViewById(R.id.perfilNombre);
        TextView c = view.findViewById(R.id.perfilCarrera);
        TextView s = view.findViewById(R.id.perfilSemestre);

        n.setText(SharedLogin.getInstans(getContext()).getUsername());
        c.setText(SharedLogin.getInstans(getContext()).getUserCarrera());
        s.setText(SharedLogin.getInstans(getContext()).getUserSemestre());

        Button button = view.findViewById(R.id.button);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SharedLogin.getInstans(getContext()).logout();

                startActivity(new Intent(v.getContext(), Sesion.class));
                getActivity().finish();
